...
from preprocess_data_over943 import PreprocessDataOver943

class PreprocessDataOver943PlusInfo():
    # 初期化
    def __init__(self, url, rotate_type):
        ...
        self.data_org = PreprocessDataOver943(self.URL, self.ROTATE_TYPE)
        self.df_addinfo = self.add_drawing_info()
        
    # 描画時の情報を追加
    def add_drawing_info(self):
        df_addinfo = self.data_org.df_unify.copy()
    ...
    # 成果物を描画
    def draw_allstroke(self, file_name, stroke_width):
        df = self.df_addinfo
        SCALE = 0.02
        plt.rcParams['font.family'] = 'Times New Roman'
        STROKE_COLOR = 'black'
        ...
        fig, ax = plt.subplots(facecolor=FACE_COLOR, figsize=(FIG_SIZE[0],FIG_SIZE[1]), dpi=10)
